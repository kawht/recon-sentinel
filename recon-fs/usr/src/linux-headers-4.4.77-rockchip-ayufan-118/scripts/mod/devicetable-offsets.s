...
// options passed:  -nostdinc -nostdinc -I ./arch/arm64/include
...
.LASF12:
	...
	.ascii	"mpc-relative-literal-loads -mabi=lp64 -g -Os -std=gnu90 -p -"
	.ascii	"fno-strict-aliasing -f"
	.string	"no-common -fno-pic -fno-asynchronous-unwind-tables -fno-delete-null-pointer-checks -fno-stack-protector -fno-omit-frame-pointer -fno-optimize-sibling-calls -fno-var-tracking-assignments -fno-strict-overflow -fconserve-stack --param allow-store-data-races=0"
.LASF4:
	.string	"unsigned int"
.LASF15:
	.string	"main"
...
.LASF2:
	.string	"short int"
.LASF14:
	.string	"/data/jenkins/workspace/linux-build-rock-64/kernel"
.LASF8:
	.string	"sizetype"
